...
} > results_openmp.txt
{
  ...
  echo "\nNP =20"
  mpirun -np 20 ./mvm_rs_mpi $rows $cols $size

  echo "\nNP =25"
  mpirun -np 25 ./mvm_rs_mpi $rows $cols $size

  echo "\nNP =32"
  mpirun -np 32 ./mvm_rs_mpi $rows $cols $size

  echo "\nNP =40"
  mpirun -np 40 ./mvm_rs_mpi $rows $cols $size
  ...
  echo "\nNP =20"
  mpirun -np 20 ./mvm_cs_mpi $rows $cols $size

  echo "\nNP =25"
  mpirun -np 25 ./mvm_cs_mpi $rows $cols $size

  echo "\nNP =32"
  mpirun -np 32 ./mvm_cs_mpi $rows $cols $size

  echo "\nNP =40"
  mpirun -np 40 ./mvm_cs_mpi $rows $cols $size
  ...
  echo "\nNP =20"
  mpirun -np 20 ./mvm_checkerboard $rows $cols $size

  echo "\nNP =25"
  mpirun -np 25 ./mvm_checkerboard $rows $cols $size

  echo "\nNP =32"
  mpirun -np 32 ./mvm_checkerboard $rows $cols $size

  echo "\nNP =40"
  mpirun -np 40 ./mvm_checkerboard $rows $cols $size
